function Home() {
    return (
        <div style={{
            ...
            <svg width="200" height="30" viewBox="0 0 162 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ marginBottom: '2rem' }}>
            ...
            <p style={{
                ...
                Logiciel Interne de Traitement des Incidents
            </p>
            ...
            <div style={{
                ...
                <a
                    ...
                    onMouseOver={(e) => {
                        ...
                        e.target.style.boxShadow = '0 8px 20px rgba(255, 205, 0, 0.4)';
                    }}
                    onMouseOut={(e) => {
